...
def browser():
    ...
    assert url_test[:16] == value_test[:16], "\nТест2 не прошел. Не выполнен переход на новую страницу проекта."
...
class TestMainPage1(): 
    ...
    def test_guest_should_see_login_link(self, browser):
        ...
        By.CSS_SELECTOR, ".MuiInputBase-input.MuiOutlinedInput-input").send_keys("1")
        #time.sleep(960)
        #browser.find_element(
